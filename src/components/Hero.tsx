...
export const Hero = ({ onPortfolioClick, onContactClick }: HeroProps) => {
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-20 px-5 md:px-20 overflow-hidden text-center md:text-center">
            ...
            <div className="max-w-6xl mx-auto animate-fade-in relative z-10 w-full flex flex-col items-center px-4">
                ...
                <div className="max-w-4xl w-full mx-auto flex flex-col items-center text-center">
                    <h1 className="w-full max-w-[90%] mx-auto text-5xl md:text-8xl font-black mb-8 tracking-tighter leading-[0.9] text-center">
                    ...
                    <p className="w-full max-w-[90%] md:max-w-2xl mx-auto text-slate-400 text-lg md:text-2xl mb-12 font-light leading-relaxed break-keep text-center">
                    ...
                    <div className="w-full flex flex-col md:flex-row gap-4 justify-center items-center">
                        <button onClick={onContactClick} className="w-full max-w-[90%] md:w-auto bg-primary text-black px-10 py-5 rounded-full font-black text-lg hover:bg-white transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
                            프로젝트 시작하기
                            <span className="material-symbols-outlined">arrow_outward</span>
                        </button>
                        <button onClick={onPortfolioClick} className="w-full max-w-[90%] md:w-auto bg-white/5 border border-white/10 text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2">
                            포트폴리오 보기
                        </button>
                    </div>
                </div>
