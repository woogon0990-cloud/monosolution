...
export const Hero = ({ onPortfolioClick, onContactClick }: HeroProps) => {
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-20 px-5 md:px-20 overflow-hidden text-center md:text-center">
            ...
            <div className="max-w-6xl mx-auto animate-fade-in relative z-10 w-full flex flex-col items-center">
                ...
                <div className="max-w-4xl w-full mx-auto flex flex-col items-center">
                    <h1 className="w-full max-w-[90%] mx-auto text-5xl md:text-8xl font-black mb-8 tracking-tighter leading-[0.9]">
                    ...
                    <p className="w-full max-w-[90%] md:max-w-2xl mx-auto text-slate-400 text-lg md:text-2xl mb-12 font-light leading-relaxed break-keep">
